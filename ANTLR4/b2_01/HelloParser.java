...
public class HelloParser extends Parser {
	...
	public static final int
		RULE_greetings = 0, RULE_a = 1, RULE_b = 2, RULE_name = 3;
	...
	public static class AContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HelloVisitor ) return ((HelloVisitor<? extends T>)visitor).visitA(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HelloVisitor ) return ((HelloVisitor<? extends T>)visitor).visitB(this);
			else return visitor.visitChildren(this);
		}
	}
